...
int main(int argc, char** argv) {
    ...
    // 
     //Parameters:
    constexpr int ticks_per_revolution = 1024; //імпульс за один оберт колеса
    constexpr float wheel_radius_m  = 0.3; //радіус колеса у метрах (діаметр 60 см)
    constexpr float wheelbase_m = 1.0; //відстань між лівим і правим бортом, у метрах
    //
